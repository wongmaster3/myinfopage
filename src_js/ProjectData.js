var data = {
    "Projects":[{"ProjectName":"MeeshQuest (Fall 2018)",
        ...
        {"ProjectName":"Personal Website (Fall 2016 - Present)",
            ...
            "ReferenceLink":"https://github.com/wongmaster3/myinfopage"},

        {"ProjectName":"Personal Text Editor (Summer 2018 - Present)",
            "Description":"Currently developing a personal text editor using JavaScript and jQuery library. Creating everything from ground up. Manipulated HTML elements to create a fluid interface with keys.",
            "ReferenceLink":"https://github.com/wongmaster3/personal-text-editor"},

        {"ProjectName":"Measuring H2O Water Contamination (Fall 2016)",
            ...
            "ReferenceLink":"https://devpost.com/software/not-just-h2o#updates"},

        {"ProjectName":"3D LED Cube (Spring 2016)",
            "Description":"Here is one of the first projects I did in High School in my engineering class. Although I did not have enough time to complete it, the experience of building it taught me more about C and Arduino. The 3D LED Cube was supposed to produce some cool patterns.",
            "ReferenceLink":"Data Not Available at this Time"},

        {"ProjectName":"Betting Game (Fall 2015)",
            ...
            "ReferenceLink":"https://scratch.mit.edu/projects/89911232/"}]
